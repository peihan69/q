...
makeMinuteBar :{[x;y]
    ...
    fullsec: update sym: y, date: x, open: 0e, high: 0e, low: 0e ,close: 0e from fullsec where sym like "";
    fullsec: update size: 0i from fullsec where size = 0n;
    fullsec
};

setDateList [2013.01.01;2014.01.01];
